...
const PageTitle = ({title, withBackButton}) => {
    ...
    return (<div className={"flex relative pt-5 px-8 flex-col z-10 "} >
        ...
        {withBackButton && <Button  onClick={() => router.back()} icon={<ArrowBack size={26}/>} className={'text-gray-500 h over:bg-primary hover:text-white rounded-full h-10 w-10 p-0 -ml-2 mr-1'} light auto></Button>}
